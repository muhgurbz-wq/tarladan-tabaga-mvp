...
public class MainActivity extends Activity {
    ...
    private void injectNativeMode(WebView view) {
        String script = "(function(){" +
                ...
                "s.textContent='.top .actions,.secureCard{display:none!important}';" +
                "document.head.appendChild(s);" +
                "window.openInstaller=function(){NativeApp.showToast('SosyalPaket telefonda uygulama olarak kurulu');};" +
    ...
    private void saveTextFile(String name, String mimeType, String content) {
        ...
        try {
            ...
            Toast.makeText(this, "Dosya kaydedilemedi", Toast.LENGTH_LONG).show();
        }
    }

    private class NativeBridge {
        @JavascriptInterface
        public void saveText(String name, String mimeType, String content) {
            runOnUiThread(() -> saveTextFile(name, mimeType, content));
        }
